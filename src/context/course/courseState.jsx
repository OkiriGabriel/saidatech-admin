...
const CourseState = (props) => {
    ...
    const getCourses = async () => {
        ...
        try {
            ...
            await Axios.get(`${process.env.REACT_APP_ADMIN_URL}/courses`, storage.getConfigWithBearer())
            .then((resp) => {
    ...
    const getCourse = async () => {
        ...
        try {
            ...
            await Axios.get(`${process.env.REACT_APP_ADMIN_URL}/courses/${storage.getUserID()}`, storage.getConfigWithBearer())
            .then((resp) => {
