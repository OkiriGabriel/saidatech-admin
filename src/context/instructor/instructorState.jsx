...
const InstructorState = (props) => {
    ...
    const getInstructors = async () => {
        ...
        try {
            ...
            await Axios.get(`${process.env.REACT_APP_ADMIN_URL}/users`, storage.getConfigWithBearer())
            .then((resp) => {
    ...
    const getInstructor = async () => {
        ...
        try {
            ...
            await Axios.get(`${process.env.REACT_APP_ADMIN_URL}/users/${storage.getUserID()}`, storage.getConfigWithBearer())
            .then((resp) => {
